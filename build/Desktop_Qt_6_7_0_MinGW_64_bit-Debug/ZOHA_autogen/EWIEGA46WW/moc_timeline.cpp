...
struct qt_meta_stringdata_CLASStimelineENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASStimelineENDCLASS = QtMocHelpers::stringData(
    "timeline",
...
Q_CONSTINIT static const uint qt_meta_data_CLASStimelineENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject timeline::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASStimelineENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASStimelineENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASStimelineENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *timeline::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASStimelineENDCLASS.stringdata0))
